...
export class BaseViewModel {
  ...
  notifyListeners() {
    if (this.thiz != null && this.thiz != undefined)
      for (var iii in this._listeners) this._listeners[iii](thiz);
  }
}
...
export class ViewModelConsumer extends React.Component {
  ...
  onRender(props, viewModel) {
    return (
      <h1 style={{ color: "red" }}>
        This ViewModelConsumer does not implement
        <code> onRender(props, viewModel)</code>
      </h1>
    );
  }
}
